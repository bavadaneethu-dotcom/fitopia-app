      ...
      <div className="flex-1 flex flex-col bg-white dark:bg-dark-bg -mt-8 rounded-t-[2.5rem] shadow-[0_-10px_40px_rgba(0,0,0,0.1)] z-10 relative overflow-hidden">
         <div className="flex-1 overflow-y-auto no-scrollbar px-8 pt-8 pb-8">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1.5">
                ...
                <div className={`relative group transition-all duration-300 ${errors.password ? 'animate-shake' : ''}`}>
                  ...
                  <input 
                    ...
                    className={`w-full bg-gray-50 dark:bg-white/5 border-2 focus:bg-white dark:focus:bg-black/20 focus:ring-0 rounded-2xl py-3.5 pl-12 pr-12 text-sm font-medium text-light-text dark:text-dark-text outline-none transition-all ${
                        errors.password 
                        ? 'border-red-300 focus:border-red-500 bg-red-50/50' 
                        : 'border-transparent focus:border-yellow-400 placeholder:text-gray-300'
                    }`}
              ...
              <div className="pt-6">
                <button type="submit" className="group relative w-full bg-yellow-400 dark:bg-yellow-500 text-black dark:text-black font-black text-base rounded-full py-4 shadow-xl shadow-yellow-400/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2">
                  <span>Sign Up</span>
