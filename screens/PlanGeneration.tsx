...
const PlanGeneration: React.FC<PlanGenerationProps> = ({ 
  ...
  // Initial calculation for calorie target based on BMI components & Mission
  useEffect(() => {
        ...
        <div className="text-center">
           ...
           <div className="bg-[#FFFBEB] dark:bg-white/5 p-4 rounded-2xl w-full flex gap-4 border-l-4 border-l-yellow-400 relative overflow-hidden text-left shadow-sm">
              <p className="text-xs font-bold italic text-gray-600 dark:text-gray-300 leading-relaxed">
                "{activeCharacter?.onboardingMessages.plan || "This is your briefing. Execute it perfectly. Dismissed!"}"
              </p>
           </div>
        </div>
        ...
        <div className={`rounded-2xl p-6 shadow-sm relative overflow-hidden transition-all duration-300 bg-slate-50 dark:bg-gray-800 border border-slate-100 dark:border-white/5`}>
          <div className="flex items-center justify-between mb-5 relative z-10">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[9px] text-gray-500 font-bold mt-1.5 uppercase tracking-[0.15em]">18:6 Academy Protocol</p>
              </div>
            </div>
          ...
          <div className={`w-full transition-all duration-500 ${fastingEnabled ? 'opacity-100' : 'opacity-30'}`}>
            ...
            <div className="flex justify-between px-0.5">
                <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Sleep</span>
                <span className="text-[9px] font-black text-yellow-600 dark:text-yellow-400 uppercase tracking-widest">Fueling</span>
                <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Sleep</span>
            </div>
          </div>
        </div>
